...
struct Map
{
    ...
    private var TheMapArray:[[MapTile]] =
        ...
        /*16*/[MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.mob, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.empty, MapTile.water, MapTile.water, MapTile.water, MapTile.water, MapTile.water, MapTile.water, MapTile.water],
